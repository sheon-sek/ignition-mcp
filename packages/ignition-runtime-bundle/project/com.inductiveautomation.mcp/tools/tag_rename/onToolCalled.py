	...
	try:
		...
		for index in range(len(paths)):
			...
			if newPathBytes > PATH_MAX_BYTES:
				return toolError("limit_exceeded", "The new path of a target is over a documented D10 input ceiling; no item was executed.", {"reason": "pathOverLength", "index": index, "path": boundedText(newPaths[index], 256), "requested": newPathBytes, "limit": PATH_MAX_BYTES})
