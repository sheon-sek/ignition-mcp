...
def test_external_models_match_contract_top_level_shapes() -> None:
    cases = (
        ...
        (PerspectiveViewListResult, "perspective-view-list.output.schema.json"),
        (PerspectiveViewGetResult, "perspective-view-get.output.schema.json"),
        (PerspectiveViewValidateResult, "perspective-view-validate.output.schema.json"),
        (PerspectivePageConfigGetResult, "perspective-page-config-get.output.schema.json"),
        (PerspectiveSessionPropsGetResult, "perspective-session-props-get.output.schema.json"),
        (PerspectiveViewWriteResult, "perspective-view-upsert.output.schema.json"),
        (PerspectiveViewWriteResult, "perspective-view-delete.output.schema.json"),
        (PerspectiveWriteResult, "perspective-page-config-update.output.schema.json"),
        (PerspectiveWriteResult, "perspective-session-props-update.output.schema.json"),
