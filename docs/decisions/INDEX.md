# Ignition MCP Architecture Decisions — D01–D31
...
D01–D31 are binding unless explicitly reopened through a new decision or amendment. Design content was frozen by the pre-D26 consistency cleanup only; see [Pre-D26 consistency cleanup](#pre-d26-consistency-cleanup-applied).
...
Treat D01–D31 plus D07-A as binding unless explicitly reopened through a later Decision or Amendment.
