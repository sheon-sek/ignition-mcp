...
A system prompt and four Agent Skills for a Cherry Studio Agent in the Analysis role, connected to `ignition-runtime-analysis` and `ignition-rest-analysis`.
